// Ejemplo alternativo usando ResponsiveModal para casos más complejos
"use client"
import { Button } from '@/ui/components/buttons';
import { RoundedButton } from '@/ui/components/buttons/RoundedButton';
import { SelectMenu, TextInput } from '@/ui/components/inputs';
import { ResponsiveModal } from '@/ui/components/modals/ResponsiveModal';
...
const UpdateProductModalResponsive = () => {
    return (
        <ResponsiveModal 
            isOpen={true} 
            onClose={() => () => true}
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <SelectMenu id='unitOfMeasure' items={[]} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <SelectMenu id='category' items={[]} />
                                    </div>
                                    
                                    <div>
                                        <LabelInput value="Marca *" htmlFor='brand' />
                                        <SelectMenu id='brand' items={[]} />
                                    </div>
                                    
                                    <div>
                                        <LabelInput value="Temporada *" htmlFor='season' />
                                        <SelectMenu id='season' items={[]} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <TextInput placeholder="Descripción del producto" />
                                </div>
                            </div>
                        </form>
                    </div>
...
export { UpdateProductModalResponsive };
